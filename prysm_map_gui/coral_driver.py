...
#====================================================================
    ...
    # yearly
    #file = open(datadir+'woa18_decav_t00mn01.csv')
    #ssta = np.loadtxt(file, delimiter=",")
    ssta=np.load(sstdatadir+'SST_Anomalies_Yearly_850-1850.npy')
    # monthly
    ssta_m=np.load(sstdatadir+'SST_Anomalies_Monthly_850-1850.npy')

    # Load SSS anomalies [psu] (NOTE: THIS SHOULD BE A 1-D VECTOR OF DATA!)
    # yearly
    sssa=np.load(sssdatadir+'SSS_Anomalies_Yearly_850-1850.npy')
    # monthly
    sssa_m=np.load(sssdatadir+'SSS_Anomalies_Monthly_850-1850.npy')
