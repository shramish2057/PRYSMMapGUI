...
to run the coral model for the passed location coordinates.
Hence, the SST and SSS datasets collected from World Ocean Atlas are used
as input datasets. 
"""
...
def coral_driver(latitude, longitude):
    ...
    #reading the World Ocean Atlas Sea Surface Temperature csv dataset
