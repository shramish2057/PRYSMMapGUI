...
def coral_driver(latitude, longitude):
    ...
    with open(sstdatadir+'woa18_5564_t00mn01.csv', 'r') as csv_file:
        ...
        with open(sstdatadir+'woa18_5564_sst.csv', 'w') as new_file:
    ...
    with open(sssdatadir+'woa18_5564_s00mn01.csv', 'r') as csv_file:
        csv_reader = csv.reader(csv_file)
        ...
        # This hence saves the sea surface temperature dataset for specific location
        # for depths ranging from 0-5500 m.
        with open(sssdatadir+'woa18_5564_sss.csv', 'w') as new_file:
            csv_writer = csv.writer(new_file, delimiter='\n')
    ...
    # yearly
    file = open(sstdatadir+'woa18_5564_sst.csv')
    ssta = np.loadtxt(file, delimiter=",")

    file = open(sssdatadir +'woa18_5564_sss.csv')
