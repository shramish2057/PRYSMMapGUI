...
to run the coral model for time period 1995-2004 and the passed location coordinates.
Hence, the SST and SSS datasets of 1995-2004 collected from World Ocean Atlas are used
as input datasets. 
"""
...
def coral_driver(latitude, longitude):
    ...
    with open(sstdatadir+'woa18_9504_t00mn01.csv', 'r') as csv_file:
        ...
        with open(sstdatadir+'woa18_9504_sst.csv', 'w') as new_file:
    ...
    with open(sssdatadir+'woa18_9504_s00mn01.csv', 'r') as csv_file:
        ...
        # This hence saves the sea surface temperature dataset for specific location
        # for depths ranging from 0-5500 m.
        with open(sssdatadir+'woa18_9504_sss.csv', 'w') as new_file:
            csv_writer = csv.writer(new_file, delimiter='\n')
    ...
    # yearly
    file = open(sstdatadir+'woa18_9504_sst.csv')
    ssta = np.loadtxt(file, delimiter=",")

    file = open(sssdatadir +'woa18_9504_sss.csv')
